          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            <div className="text-white">
              ...
              <p className="text-green-400/80 text-xs sm:text-sm mb-7 sm:mb-8 max-w-lg">
                Issued: 18 Feb 2026 &nbsp;|&nbsp; Valid until: 17 Feb 2029
                <br />
                Surveillance audits: Feb 2027 &amp; Feb 2028
              </p>
              <Link
                href="/certifications"
              ...
              { [
                {
                  ...
                  certNo: "HACCP-26021810",
                  sub: "Hazard Analysis & Critical Control Points",
                },
                {
                  icon: Award,
                  label: "U.S. FDA Compliant",
                  certNo: "FDA-26021809",
                  sub: "FDA Regulatory Guideline Compliance",
                },
                {
                  icon: FlaskConical,
                  label: "HALAL Certified",
                  certNo: "HALAL-26021811",
                  sub: "Islamic Shariah Law — Lawful for Muslim Consumption",
                },
                {
                  icon: Activity,
                  label: "UKAF Accredited",
                  certNo: "UKAF-CB-021",
                  sub: "IPQ Management System, London UK",
                },
              ].map((item) => (
                <div
                  key={ item.certNo }
                  className="bg-white/5 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-white/10 hover:bg-white/10 transition-colors"
                >
                  <item.icon size={ 22 } className="text-green-400 mb-3 sm:mb-4" />
                  <div
                    className="text-white font-bold text-sm sm:text-base mb-1 leading-snug"
                    style={ { fontFamily: "'Montserrat', sans-serif" } }
                  >
                    { item.label }
                  </div>
                  <div className="text-gray-400 text-[10px] sm:text-xs mb-2 leading-snug">{ item.sub }</div>
                  <div className="text-green-400 text-[10px] sm:text-xs font-mono tracking-wide">
                    { item.certNo }
                  </div>
                </div>
              )) }
